...
class Avatar extends react_1.Component {
    ...
    render() {
        ...
        if (imageAble) {
            ...
            const SafeImage = this.props.animatedIntegrated ? react_native_1.Animated.Image : react_native_1.Image;
            return react_native_1.Platform.select({
                android: <SafeImage defaultSource={require('../../assets/account_placeholder.png')} // Note: On Android, the default source prop is ignored on debug builds.
                 source={hasError ? require('../../assets/account_placeholder.png') : this.props.source} resizeMode={this.props.resizeMode} style={[
                        {
                ...
                ios: <SafeImage defaultSource={require('../../assets/account_placeholder.png')} source={hasError ? require('../../assets/account_placeholder.png') : this.props.source} resizeMode={this.props.resizeMode} style={[
                        {
                            borderRadius: this.props.rounded ? size / 2 : undefined,
                            height: size,
                            width: size,
